...
public class Result {
    ...
    public String getArtWorkBig(int size) {         //not documented in API
        String out = artworkUrl100;
        out =  String.format("%s/%2$dx%2$d.jpg",out.substring(0, out.lastIndexOf('/')), size);
        return out;
    }
}
